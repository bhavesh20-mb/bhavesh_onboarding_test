...
export type ProviderType = ConstructorParameters<typeof ethers.providers.Web3Provider>['0'];

export type WriteContractResponseType = { wait: () => Promise<unknown> };
...
export class Erc20Contract implements IErc20Contract {
    ...
    constructor(chainId: number, contractAddress: string) {
        ...
        this.chain = CHAINS.find((item) => item.id === chainId)!;
        ...
        this.contract = new ethers.Contract(
            ...
            ABI,
            new ethers.providers.JsonRpcProvider(this.chain.rpc[0]),
        );
    }
